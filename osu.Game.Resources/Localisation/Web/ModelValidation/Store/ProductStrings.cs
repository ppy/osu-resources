...
namespace osu.Game.Resources.Localisation.Web.ModelValidation.Store
{
    public static class ProductStrings
    {
        private const string prefix = @"osu.Game.Resources.Localisation.Web.ModelValidation.Store.Product";
